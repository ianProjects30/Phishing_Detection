...
def create_user(email, password):
    # --- Prevent bcrypt overflow ---
    password = password[:50]  # Keep within safe limits
    ...
    # Combine and truncate before hashing (bcrypt max 72 bytes)
...
def google_login():
    ...
    # --- FIX: Short dummy password (prevents bcrypt overflow) ---
